...
var Banner = function(bannerId, bannerSlides, autoRotateFlag, animateFlag) {
  ...
  var nextSlide = {
    ...
    aside: element.querySelector('div.current-slide>.content>.row>aside') || null,
  ...
  function animateInView() {
    var text = new SplitText("#banner-text", { type: "chars, words" });
    var timeline = new TimelineMax();
    timeline.staggerFrom([currentSlide.number, currentSlide.title, currentSlide.text, currentSlide.aside], 0.5, {
        opacity: 0,
        y: "100%",
        ease: Power3.easeOut
      }, 0.15);
