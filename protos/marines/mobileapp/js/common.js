...
function initSearch() {
    ...
    (function ($) {
        ...
        $(document).bind("click", function (e) {
            if ($(e.srcElement).hasClass('skin-search-input')) {
                return true;
            }
...
function initMenu() 
{
    (function ($) {
        ...
        $('header .nav-main span').click(function (e) {
            if ($(e.srcElement).parents(":eq(1)").hasClass('social-item')) {
                return true;
            }
            $(e.srcElement).fadeOut().fadeIn().next().fadeIn();
            var n = $(e.srcElement).parent().next();
            if (n.hasClass('open')) {
                n.fadeOut();
                n.removeClass('open');
            }
