...
<div id="gallery-of-hero-photos" class="gallery-of-hero-photos background-color-primary">
    ...
    <div class="container-fluid no-gutters nopad">
      <div class="row no-gutters">
        <div class="col-6 col-sm-6 col-md-6 col-lg-5">
          <a class="carousel-control-prev" id="carousel-control-prev" role="button" data-slide="prev">
        ...
        <div class="col-6 col-sm-6 col-md-6 col-lg-5">
          <a class="carousel-control-next" id="carousel-control-next" role="button" data-slide="next">
  ...
  <div class="slider">
    <div class="wrapper">
      <div class="item active"><img src="[i:src]" alt="[i:alt]" /></div>
      <div class="item"><img src="/publicmedia/2019/Mar/06/2000783161/1088/820/0/140117-M-VM429-5521.JPG" alt="[i:alt]" /></div>
      <div class="item"><img src="/publicmedia/2019/Mar/06/2000783166/1088/820/0/180929-M-EH415-0246.JPG" alt="[i:alt]" /></div>
      <div class="item"><img src="/publicmedia/2019/Mar/06/2000783167/1088/820/0/180930-M-HD015-0025.JPG" alt="[i:alt]" /></div>
      <div class="item"><img src="/publicmedia/2019/Mar/06/2000783164/1088/820/0/180921-M-UA092-1007.JPG" alt="[i:alt]" /></div>
    </div>
  </div>
</div>
          ...
          <div class="carousel-div">
            <div class="wrapper">
              <div id="carousel-of-thumbs" class="carousel-of-thumbs slide row">
                <div class="carousel-inner w-100 mx-auto row" role="listbox">
                  <div class="item col-md-3 col-sm-6 col-6 align-self-center">
                    <img src="[i:src]" alt="[i:alt]" title="[i:smurl]">
                  </div>
                  <div class="item col-md-3 col-sm-6 col-6 align-self-center">
                    <img src="/publicmedia/2019/Mar/06/2000783161/1088/820/0/140117-M-VM429-5521.JPG" alt="[i:alt]" />
                  </div>
                  <div class="item col-md-3 col-sm-6 col-6 align-self-center">
                    <img src="/publicmedia/2019/Mar/06/2000783166/1088/820/0/180929-M-EH415-0246.JPG" alt="[i:alt]" />
                  </div>
                  <div class="item col-md-3 col-sm-6 col-6 align-self-center">
                    <img src="/publicmedia/2019/Mar/06/2000783167/1088/820/0/180930-M-HD015-0025.JPG" alt="[i:alt]" />
                  </div>
                  <div class="item col-md-3 col-sm-6 col-6 align-self-center">
                    <img src="/publicmedia/2019/Mar/06/2000783164/1088/820/0/180921-M-UA092-1007.JPG" alt="[i:alt]" />
                  </div>
                </div>
              </div>
            </div>
...
<div class="pnlPrevNextGallery">
    <a id="gallery-load-prev" class="gallery-prev gallery-left-arrow" href="#smallThumbCarousel" role="button" data-slide="prev">&nbsp;</a>
    <a id="gallery-load-next" class="gallery-next gallery-right-arrow" href="#smallThumbCarousel" role="button" data-slide="next">NEXT&nbsp;</a>
</div>
[/i:usePrevNextGallery]
...
<script type="text/javascript">
  ...
  */
  function AnimateGalleryImage() {
    ...
    var prev = document.getElementById('carousel-control-prev');
    var next = document.getElementById('carousel-control-next');
    var down = document.getElementById('carousel-control-down');
    if (!control || !prev || !next) return;

    var timeline = new TimelineMax({ paused: true, delay: 1.5 });
    timeline
      .addLabel('show')
      .to(prev, 0.5, { opacity: 1, x: 0, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 'show')
      .to(down, 0.5, { opacity: 1, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 'show')
      .to(next, 0.5, { opacity: 1, x: 0, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 'show');
  ...
  function AnimateGalleryCarousel() {
    var items = [], isShown = false;
    var title = document.getElementById('main-photo-title');
    var imgs = document.querySelectorAll('#carousel-of-thumbs img');
    var link = document.getElementById('carousel-dual-link');
    if (imgs && imgs.length > 0) items.push(imgs);

    var timeline = new TimelineMax({ paused: true, delay: 0.5 });
    timeline
      .addLabel('title')
      .to(title, 0.5, { opacity: 1, y: 0, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 'title')
      .addLabel('carousel')
      .staggerTo(items, 0.5, { opacity: 1, y: 0, scale: 1, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 0.5, 'carousel')
      .addLabel('dual-link')
      .to(link, 0.5, { opacity: 1, y: 0, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 'dual-link');
  ...
  function AnimateGalleryBody() {
    ...
    timeline
      .addLabel('details')
      .staggerTo([dateline, photodata], 0.5, { opacity: 1, y: 0, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 0.3, 'details')
      .staggerTo([attrs],  0.5,  { opacity: 1, y: 0, ease: 'cubic-bezier(0.0, 0.0, 0.2, 1)' }, 0.3, 'details');
  ...
  /*
    ImageGallerySlider - Slideshow of photos managed by carousel of thumbnails below
    @developer - Ella Musina (emusina@omnitecinc.com)
  */
  var ImageGallerySlider = ImageGallerySlider || function(config) {
    ...
    // banner nav
    var prevHero = document.getElementById('carousel-control-prev');
    var nextHero = document.getElementById('carousel-control-next');
    // thumbs nav
    var prev = document.getElementById('thumbs-carousel-prev');
    var next = document.getElementById('thumbs-carousel-next');
    // thumbs carousel
    var carousel = document.getElementById('carousel-of-thumbs');
    var wrapper = document.querySelector('#carousel-of-thumbs>.carousel-inner');
    var thumbs = wrapper.querySelectorAll('.carousel-inner>.item');
    var isAnimating = false;
    if (!views || !carousel || !thumbs) return;
    ...
    function setCarouselDistance() {
      ...
      console.log('Image Gallery Slider > distance =', distance, ', jump =', jump, ', total jumps =', totalJumps);
    }

    function slideIn(e) {
      console.log('Image Gallery Slider > slide-in');
      var thumb = e.target;
    ...
    function slideInFromLeft(thumb) {
      console.log('Image Gallery Slider > slide-in-from-left');
    ...
    function slideInFromRight(thumb) {
      console.log('Image Gallery Slider > slide-in-from-right');
      thumb.classList.add('current');
      var timeline = new TimelineMax({
        paused: true,
        onStart: function(){
    ...
    function moveLeft() {
      console.log('Image Gallery Slider > move left');
    ...
    function moveRight() {
      console.log('Image Gallery Slider > move right');
    ...
    function moveThumbsRight() {
      console.log('Image Gallery Slider > move thumbs right');
      if (jump - 1 >= 0) {
        jump--;
      } else {
        jump = totalJumps - 1;
    ...
    function moveThumbsLeft() {
      console.log('Image Gallery Slider > move thumbs left');
    ...
    function observe() {
      ...
      // prevHero.addEventListener('touch', function() { moveRight(); }, false);
      nextHero.addEventListener('click', function(e) {
        e.stopPropagation();
        moveRight();
      }, false);
      // nextHero.addEventListener('touch', function() { moveLeft(); }, false);
  ...
  /*
    ...
    @developer Ella Musina (emusina@omnitecinc.com)
  */
  var RelatedNewsCarousel = RelatedNewsCarousel || function(config) {
    console.log(config);
    ...
    console.log('RelatedNewsCarousel()');
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    AnimateGalleryBody();
    var slider = new ImageGallerySlider({
    ...
    var carousel = new RelatedNewsCarousel({
